...
struct	pentry	{
	...
	int	prev_counter;		/* contains the counter value that was from previous epoch */
	int	time_quantum;           /* quantum value for the process */
	int 	goody;			/* storing the goodness value */
};
